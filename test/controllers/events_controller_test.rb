...
class EventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update event" do
    patch event_url(@event), params: { event: { description: @event.description, end_time: @event.end_time, price: @event.price, start_time: @event.start_time, title: @event.title } }
